...
DEFAULT_MODEL_NAME = "fla-hub/gla-1.3B-100B"
...
# Historical Modal volume for provenance: gla-validation-data
...
def main() -> None:
    parser = argparse.ArgumentParser(description="GLA validation pipeline.")
